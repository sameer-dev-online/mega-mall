...
export const addToCart = asyncHandler(
  ...
  products: {
    ...
    return res
      .status(201)
      .json(new ApiResponse(true, 201, "Product added to cart successfully.", cartItems));
  }
);
...
if(!toggledQuantity) {
  return res
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(true, 200, "Product quantity updated successfully.", cartItems)
      );
...
export const removeProduct = asyncHandler(
  async (req: newRequest, res: Response) => {
    ...
    return res
      .status(200)
      .json(
        new ApiResponse(true, 200, "Product removed from cart successfully.", cartItems)
      );
  }
);
